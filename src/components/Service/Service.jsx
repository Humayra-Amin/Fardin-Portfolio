    ...
    <div className="bg-[#251C31] py-16 px-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 max-w-7xl mx-auto">
        {services.map((service, index) => (
          <div
            key={index}
            className="bg-[#513279] border-2 border-[#c1a7e4] rounded-3xl shadow-xl p-8 flex flex-col items-center text-center transform hover:-translate-y-3 hover:scale-105 transition-transform duration-300 group"
          >
            <div className="mb-4">{service.icon}</div>
            <h3 className="text-2xl font-semibold text-white mb-2 group-hover:text-[#edabff] transition-colors duration-300">
              {service.title}
            </h3>
